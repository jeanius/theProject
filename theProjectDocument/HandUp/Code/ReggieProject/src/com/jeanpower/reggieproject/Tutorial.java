...
public class Tutorial implements View.OnClickListener{
	 ...
	 * Constructor.
	 * <p>
	 * Pulls arrays of tutorial texts and sets up first Dialog to show user. <br>
	 * This involves setting text, setting yes/no button layout, creating layout parameters for ShowcaseView "Ok" button <br>
	 * <p>
	 * @param ma - MainActivity, calling class
	...
	public Tutorial(MainActivity ma, Game g) {
		...
		yesParams.setMargins(0, 10, 0, 10); //A little away from the edges.
		...
		okParams.bottomMargin=main.getHeight() * 2;
	 ...
	 * Click Listener
	 * <p>
	 * Stops tutorial being shown, if user does not want to see. <br>
	 * Else, sets the counter for the next dialog/showcaseview to be shown. <br>
	 * Also sets up Arrow on screen, if required. Necessary to add here, to allow for highlight in Showcaseview in time, due to Android layout passes<br>
	 * <p>
	 ...
	 * also adds a program image to dialog.<br>
	 * At last screen, sets up program on screen for user to interact with.
	 * <p>
	 * @param void
	 * @return void
	 */
	 ...
	 * <p>
	 * Includes two special circumstances where the user can click outside the focus circle.
	 * <p>
	 * @param void
	 * @return void
	 */
